...
final class Utilities {
    ...
    /**
     * Returns a bitmap suitable for the all apps view. Used to convert pre-ICS icon bitmaps that are stored in the
     * database (which were 74x74 pixels at hdpi size) to the proper size (48dp)
     */
