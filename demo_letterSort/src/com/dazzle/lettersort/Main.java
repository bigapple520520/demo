...
public class Main extends Activity {
    ...
    private void init2() {
        setContentView(R.layout.swipeview_item);

        View content = LayoutInflater.from(this).inflate(R.layout.letter_show_content, null);
        TextView leftText = (TextView) content.findViewById(R.id.leftText);
        leftText.setText("1111111111");

        View behind = LayoutInflater.from(this).inflate(R.layout.letter_show_behind, null);
