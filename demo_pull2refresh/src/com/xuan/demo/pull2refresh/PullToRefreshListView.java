package com.xuan.demo.pull2refresh;
...
public class PullToRefreshListView extends ListView implements OnScrollListener {
	...
	private void init(Context context) {
		...
		arrowImageView = (ImageView) headView
				.findViewById(R.id.head_arrowImageView);// 箭头图片
		arrowImageView.setMinimumWidth(50);
		arrowImageView.setMinimumHeight(50);

		progressBar = (ProgressBar) headView
				.findViewById(R.id.head_progressBar);// 进度圈

		tipsTextview = (TextView) headView.findViewById(R.id.head_tipsTextView);// 提示文本

		lastUpdatedTextView = (TextView) headView
				.findViewById(R.id.head_lastUpdatedTextView);// 最后一次更新时间提醒
		...
		// 之所以去头部本身的高度，就是要正好隐藏头部（padding设置成负的自身高度就ok了）
