 ...
 * $Id$
 */
package com.xuan.zxingutils.lib.utils;
...
import com.xuan.zxingutils.lib.decoding.DecodeFormatManager;
...
public abstract class ZxingUtils {
     ...
     */
    public static Bitmap encodeToBitmap(String content, ZEConfig config) throws WriterException, Exception {
        ...
        BitMatrix result = writer.encode(content, BarcodeFormat.QR_CODE, config.getBitmapWidth(),
    ...
    public static Bitmap encodeToBitmap(String content) throws WriterException, Exception {
        return encodeToBitmap(content, (ZEConfig) null);
    }
    ...
    public static Bitmap encodeToBitmap(String content, String saveFileName) throws WriterException, Exception {
        return encodeToBitmap(content, new ZEConfig(saveFileName));
    }
