 ...
 * $Id$
 */
package com.xuan.zxingutils.demo;
...
import com.xuan.zxingutils.R;
import com.xuan.zxingutils.lib.config.ZEConfig;
import com.xuan.zxingutils.lib.utils.ZxingUtils;
...
public class TestActivity extends Activity {
    ...
    private static final int CAPTURE_ACTIVITY = 2;// 扫描二维码界面
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    ZEConfig config = new ZEConfig(fileName);
                    Bitmap bitmap = ZxingUtils.encodeToBitmap(content, config);
        ...
        button2.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(TestActivity.this, CActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (RESULT_OK == resultCode) {
            ...
            else if (CAPTURE_ACTIVITY == requestCode) {
                edittext.setText(data.getStringExtra(CActivity.BARCODE_FORMAT) + ":"
                        + data.getStringExtra(CActivity.RESULT_TEXT));
            }
        }
    }
}
