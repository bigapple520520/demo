...
public class HolographicOutlineHelper {
    ...
    /**
     * Apply an outer blur to the given bitmap. You should use OUTER_BLUR_RADIUS to ensure that the bitmap is big enough
     * to draw the blur without clipping.
     */
    ...
    void applyExpensiveOutlineWithBlur(Bitmap srcDst, Canvas srcDstCanvas, int color, int outlineColor,
            Paint alphaClipPaint, int thickness) {
