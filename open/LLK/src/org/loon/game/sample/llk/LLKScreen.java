 ...
 * 
 * @author xuan
 * @version $Revision: 1.0 $, $Date: 2014-4-24 下午8:08:42 $
 */
public class LLKScreen extends Screen {
    ...
    final private static String WAIT_MES = "预备……";
    final private static String HELP_MES = "我能为你提供什么服务吗？";
        ...
        mes = new LMessage(Images.getInstance().getImage(14), (getWidth() - 460) / 2, getHeight() - 126 - 10) {
            ...
            public void doClick() {
                            ...
                            public void run() {
                                ...
                                if (stageNo < 5) {
                                    if (helpRole == null) {
                                        ...
                                        helpRole.setLocation(LLKScreen.this.getWidth() - helpRole.getWidth() - 10,
                                                LLKScreen.this.getHeight() - helpRole.getHeight() - 10);
                ...
                if (HELP_MES.equalsIgnoreCase(getMessage()) && isComplete()) {
                    setVisible(false);
                    select = new LSelect(Images.getInstance().getImage(14), (LLKScreen.this.getWidth() - 460) / 2,
                ...
                if (grid[sy][sx].isVisible()) {
                    for (int ey = sy; ey < yBound - 1; ey++) {
                        for (int ex = 1; ex < xBound - 1; ex++) {
                            if (grid[ey][ex].isVisible() && (ey != sy || ex != sx) && grid[sy][sx].equals(grid[ey][ex])) {
